...
// use arrow function when you want to preserve the value of the this keyword.
...
// loop use forEach or map
// but we can't use break or continue
...
for(var i = 0; i < boxesArr5.length; i++){
    if(boxesArr5[i].className === 'box blue'){
        ...
        boxesArr5[i].textContent = 'testing';
    }
}
...
// ES5 Array.prototype.slice.call(all);
// ES6 Array.from(all);
...
function isFullAge6(...year){
    year.forEach(cur => console.log((2016 - cur) >= 18));
}
...
function isFullAge6(limit, ...year){
    year.forEach(cur => console.log((2016 - cur) >= limit));
}
...
// hash map: Map String key to a value
/*
